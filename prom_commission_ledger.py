...
def collect() -> tuple:
    ...
    for o in orders:
        ...
        if comp["total"] <= 0 and comp["base"] <= 0:
            # немає комісії (напр. cpa_commission ще не проставлено в перші хвилини) — не кандидат,
            # і НЕ фіксуємо в курсорі, щоб узяти на наступному прогоні, коли Prom проставить.
            continue
