...
- якщо floor > кандидат (навіть на 1 копійку — ЖОДНОЇ "грації") -> "delist",
  ...
  prom_catalog_sync.py). Раніше тут була "грація" 1.5x і повне виключення
  buyBox-джерела з delist — обидва прибрано, вони і були причиною
  системного розриву 10-31%.
