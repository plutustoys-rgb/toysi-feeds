...
def _login() -> str:
    """
    POST /sites — авторизація РЕАЛЬНИМ логіном і паролем від Особистого кабінету
    продавця (Rozetka Seller API так документує авторизацію — на відміну від
    Prom, тут немає окремого статичного API-ключа/scoped-токена). Пароль
