...
# Фільтр звірено ЖИВО на feed-data:meta_feed.xml (5187 товарів, 2026-08-20): ловить 33 репліки
# (усі 20 відомих SMM + 13 схожих), 0 із 136 водяних пістолетів, 0 легальних (парасольки
...
_PROJECTILE_WORDS = ("кульк", "пульк", "страйкбол", "металев", "пістон")
