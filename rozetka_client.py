...
# ⚠️ Коди нижче (3/4/6/61) — НЕ звірені живо (apidoc id колізують між енумами: order-status
# vs служби доставки vs причини скасування). Перед використанням у TTN-стадії підтвердити
# реальні коди «Передано до служби доставки»/«Очікує отримання від продавця» через
# status_available живого замовлення на цій стадії. TERMINAL_STATUSES звірено — коректні.
...
ORDER_STATUS_AUTO_TRACKED      = 61  # ⚠️ НЕ звірено
