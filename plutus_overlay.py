"""overlay_demo.py — Плутус НАКЛАДЕНИЙ на картку товару (концепція власника, як Office-помічник).
...
фото (інтегральне зображення по «білості», ухил донизу) — не перекриває товар.
...
ЗАПУСК:
    python overlay_demo.py --scene sceneNN_..._GREEN.mp4 --product товар.jpg --out out.mp4
