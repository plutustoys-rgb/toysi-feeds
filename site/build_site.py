...
<ul>
<li><b>Телефон:</b> [ЗАПОВНИТИ: телефон]</li>
<li><b>Viber / Telegram:</b> [ЗАПОВНИТИ: Viber/Telegram]</li>
<li><b>Електронна пошта:</b> [ЗАПОВНИТИ: email]</li>
<li><b>Графік роботи:</b> [ЗАПОВНИТИ: графік роботи]</li>
</ul>
<p>Пишіть або телефонуйте у зручний для вас спосіб — ми відповімо якнайшвидше в робочий час. Якщо не вдалося додзвонитися, залиште повідомлення, і ми обов'язково передзвонимо.</p>"""
...
<p>Продавець: [ЗАПОВНИТИ: ФОП ПІБ], реєстраційні дані: [ЗАПОВНИТИ: ЄДРПОУ/ІПН], адреса: [ЗАПОВНИТИ: адреса]. Покупець — будь-яка дієздатна особа, яка оформила замовлення на сайті plutustoys.com.ua.</p>
...
<p>[ЗАПОВНИТИ: ФОП ПІБ]<br>[ЗАПОВНИТИ: ЄДРПОУ/ІПН]<br>[ЗАПОВНИТИ: адреса]</p>"""
