...
# "рюкзаки" (98 SKU, 3-тя за розміром категорія) НАВМИСНО не заповнено — у
# Prom є 5+ підкатегорій рюкзаків (дитячі/міські/спортивні/туристичні тощо,
# 15-20%), без звірки з фактичними товарами ризиковано вгадати неправильно;
# краще лишити на дефолті, ніж підставити хибну цифру, що впливає на floor.
# TODO (власник): звірити "рюкзаки"/"басейни" і заповнити решту категорій.
PROM_CATEGORY_COMMISSION: dict[str, float] = {
    ...
    "басейни": 0.1175,  # непідтверджено на 100% — див. коментар вище
}
