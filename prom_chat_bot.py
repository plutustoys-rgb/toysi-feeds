...
_ACK_STOP_MARKERS = (
    ...
    "поверн", "гаранті", "не працю", "брак", "злама", "розбит", "пошкодж", "не той",
    "не таке", "не те", "скарг", "проблем", "чому", "несправн", "дефект", "битий", "бите",
    "обміня", "недостач", "не вистача", "не вклали", "не доклали",
)
ACK_ANSWER = (
