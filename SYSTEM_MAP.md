...
2d. **Автопробудження НЕ вантажить персону/CLAUDE.md/скіл (перевірено живо 2026-09-14, архітектурний
   ...
   КОДВ/Консультант у `agent_watch.py` взагалі нема — вони йдуть лише ручним шляхом. Продажник —
   Є в `agent_watch.py` (додано 2026-09-17): будиться на `## [X → Продажник]` у `SELLER_CHANNEL.md`,
