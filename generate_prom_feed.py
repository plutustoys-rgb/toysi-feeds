...
# звіряється з назвою категорії від постачальника — вона є надійним джерелом
# істини незалежно від помилок друку в назві товару.
...
def append_clearance_notice(description: str, name: str, category_name: str = "") -> str:
    ...
    if not is_clearance_item(name, category_name):
        return description
    separator = "<br/><br/>" if description else ""
    return description + separator + CLEARANCE_NOTICE


def is_clearance_item(name: str, category_name: str = "") -> bool:
