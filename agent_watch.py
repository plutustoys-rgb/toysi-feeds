...
WATCHERS = [
    {
        ...
        "wake_prompt": (
            ...
            "(правило «тест на реальному дампі» — без репо ти не звіриш); cost/margin у спільні файли — ні."
        ),
    },
    {
        "name": "SEO",
        ...
        "wake_prompt": (
            ...
            "вже розібране/закрите (напр. «укр-назви» вже спростовано). Дій самостійно; нічого "
    ...
    },
    {
        ...
        "wake_prompt": (
            ...
            "вже розібране. Meta Ads не чіпай (фаза 2). Нічого незворотного/публічного без "
