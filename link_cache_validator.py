...
ЗАПОБІЖНИК (щоб транзієнтний збій prom.ua не витер кеш): якщо ЧАСТКА МЕРТВИХ лінків (до
ре-резолву) перевищує SAFE_CHANGE_RATIO — АБОРТ без запису й без ре-резолву (масові «мертві»
= радше збій мережі, а не реальні 404). Порожній/нечитабельний кеш → нічого не пишемо.
